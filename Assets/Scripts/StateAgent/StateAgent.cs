...
public class StateAgent : Agent
{
    ...
    void Start()
    {
        ...
        stateMachine.AddTransition(typeof(ChaseState).Name, new Transition(  new Condition[] { new FloatCondition(enemyDistance, Condition.Predicate.LESS_EQUAL, 5) }), typeof(AttackState).Name);
